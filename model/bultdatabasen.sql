...
CREATE TABLE IF NOT EXISTS `point` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_point_1_idx` (`installer_id` ASC) VISIBLE,
  CONSTRAINT `fk_point_1`
    FOREIGN KEY (`installer_id`)
    REFERENCES `installer` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `point_route`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `point_route` (
  `point_id` VARCHAR(36) NOT NULL,
  `route_id` VARCHAR(36) NOT NULL,
  PRIMARY KEY (`point_id`, `route_id`),
  INDEX `fk_point_route_2_idx` (`route_id` ASC) VISIBLE,
  CONSTRAINT `fk_point_route_1`
    FOREIGN KEY (`point_id`)
    REFERENCES `point` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_point_route_2`
